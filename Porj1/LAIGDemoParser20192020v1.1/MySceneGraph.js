  ...
  parsePrimitives(primitivesNode) {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      if (primitiveType == "rectangle") {
        ...
        var rectTriangle = new MyTriangle(this.scene, primitiveId, x1, y2, z1, x2, y2, z2, x3, y3, z3);
        ...
        var rectCylinder = new MyCylinder(
          this.scene,
          primitiveId,
          slices,
          stacks,
        ...
        var rectSphere = new MySphere(this.scene, primitiveId, radius, slices, stacks);

        this.primitives[primitiveId] = rectSphere;
      } 
